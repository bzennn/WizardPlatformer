...
namespace WizardPlatformer {
	public class EntityMeleeAttack : EntityAttack {
		...
		public EntityMeleeAttack(int health, int sourceId, int damage, float velocity, bool emulatePhysics, int hitBoxWidth, int hitBoxHeight, int hitBoxSpritePosX, int hitBoxSpritePosY, int posX, int posY, int roomSizeId, Level level, Vector2 directionVector) 
			: base(health, sourceId, damage, velocity, emulatePhysics, hitBoxWidth, hitBoxHeight, hitBoxSpritePosX, hitBoxSpritePosY, posX, posY, roomSizeId, level, directionVector) {
